...
| `Sources/MCPTools` | The 52 tool definitions, handlers, and backend router |
...
52 tools — full parameter documentation in **[docs/TOOLS.md](docs/TOOLS.md)** (generated from the live server's `tools/list`).
