...
struct PermissionsView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("AgentController needs these permissions to inspect and control macOS applications for AI agents.")
            ...
            VStack(spacing: 12) {
                ...
                PermissionRow(
                    ...
                    action: {
                        ...
                        // macOS registers AgentController in the Screen Recording list. Without
