...
struct SetupManager {
    ...
    private static func installBridgeScript() {
        ...
        // (Contents/Resources/macoestro-mcp-bridge.sh). Install it when missing and
        ...
        if let bundled = Bundle.main.url(forResource: "macoestro-mcp-bridge", withExtension: "sh"),
